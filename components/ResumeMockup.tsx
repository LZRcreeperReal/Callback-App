export default function ResumeMockup() {
  return (
    <div className="relative mx-auto w-[340px] origin-top scale-[0.85] sm:scale-100">
      ...
      {/* stamp */}
      <div className="absolute -left-8 bottom-24 z-20 -rotate-12 rounded border-2 border-go px-3 py-1 font-mono text-xs font-semibold uppercase tracking-widest text-go opacity-90">
        ATS-safe ✓
      </div>
      ...
      <div className="relative -rotate-2 rounded-sm border border-ink/10 bg-white p-6 shadow-xl">
        ...
        <div className="mt-5 border-t border-ink/10 pt-4">
          ...
          <p className="mt-3 text-xs leading-relaxed text-ink/30 line-through decoration-pen decoration-2">
            Responsible for managing a team and overseeing projects.
          </p>
