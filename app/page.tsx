      ...
      <section className="mx-auto max-w-6xl px-6 pb-20 pt-16 sm:pb-28 sm:pt-24">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 font-mono text-xs text-ink/40">One free scan per person. No card needed.</p>
          </div>
          <ResumeMockup />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {Object.values(SERVICES).map((service) => (
              <PricingCard key={service.id} service={service} featured={service.id === 'complete-bundle'} />
            ))}
          </div>
        </div>
      </section>
