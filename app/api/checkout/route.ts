...
export async function POST(req: NextRequest) {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      // you create in the Dashboard called LAUNCH10). This is what powers
      // the announcement bar on the homepage — no fake discount here, it's
      // a real, Stripe-validated code with a real expiration if you set one.
